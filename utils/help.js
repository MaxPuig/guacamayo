...
function sendHelpCommands(msg, prefix) {
    if (msg.content.toLowerCase() == `${prefix}help`) {
        ...
        mensaje += '`' + prefix + 'prefijo <nuevo prefijo>` para cambiar el prefijo de los comandos. Ejemplo `.prefijo !`\n';
        mensaje += '`' + prefix + 'rss` para establecer ese canal de texto para recibir ofertas de juegos. `' + prefix + 'rss borrar` para deshacerlo. (Solo admins del server)\n'
